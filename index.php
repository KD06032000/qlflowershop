        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="product_list">
                        <div class="single_product">
                            <a href="product.php" target="main"><img src="img/product/pr1.png" alt="" /></a>
                            ...
                            <div class="product_detail">
                                ...
                                <div class="product_button">
                                    <div class="cart_details">
                                        <a href="cart.php" target="blank">Add to cart</a>
                                    </div>
                                    <div class="cart_details">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="product_list">
                        <div class="single_product">
                            <a href="product.php" target="main"><img src="img/product/pr2.png" alt="" /></a>
                            <div class="product_details">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="product_list">
                        <div class="single_product">
                            <a href="product.php" target="main"><img src="img/product/pr3.png" alt="" /></a>
                            <div class="product_details">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="product_list">
                        <div class="single_product">
                            <a href="product.php" target="main"><img src="img/product/pr4.png" alt="" /></a>
                            <div class="product_details">
            ...
            <div class="row">
                <div class="product_bottom_area">
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="product_list">
                            <div class="single_product">
                                <a href="product.php" target="main"><img src="img/product/pr5.png" alt="" /></a>
                                <div class="product_details">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="product_list">
                            <div class="single_product">
                                <a href="product.php" target="main"><img src="img/product/pr6.png" alt="" /></a>
                                <div class="product_details">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="product_list">
                            <div class="single_product">
                                <a href="product.php" target="main"><img src="img/product/pr7.png" alt="" /></a>
                                <div class="product_details">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="product_list">
                            <div class="single_product">
                                <a href="product.php" target="main"><img src="img/product/pr8.png" alt="" /></a>
                                <div class="product_details">
            ...
            <div class="row">
                <div class="product_bottom_area">
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="product_list">
                            <div class="single_product">
                                <a href="product.php" target="main"><img src="img/product/pr9.png" alt="" /></a>
                                <div class="product_details">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="product_list">
                            <div class="single_product">
                                <a href="product.php" target="main"><img src="img/product/pr10.png" alt="" /></a>
                                <div class="product_details">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="product_list">
                            <div class="single_product">
                                <a href="product.php" target="main"><img src="img/product/pr11.png" alt="" /></a>
                                <div class="product_details">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="product_list">
                            <div class="single_product">
                                <a href="product.php" target="main"><img src="img/product/pr12.png" alt="" /></a>
                                <div class="product_details">
