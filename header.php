					...
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
						...
						<div class="account_card_area"> 
							<ul id="account_nav">
								...
								<li><a href="cart.php"><i class="fa fa-shopping-cart"></i>Cart <span class="cart_zero">2</span></a>
					...
					<div class="col-md-12">
						...
						<div class="main_menu">
							<ul id="nav_menu" class="active_cl">
								<li><a href="index.php"><span class="Home">Home</span></a>
									<div class="home_mega_menu">
										<a href="index-2.php">Home 2</a>
										<a href="index-3.php">Home 3</a>
									</div>
								</li>
								<li><a href="shop.php"><span class="Clothings">Shop</span></a>
								...
								<li><a href="shop.php"><span class="Sales">Clothing</span></a>
								</li>
								<li><a href="shop.php"><span class="Accessaries">Pages</span></a>
									<div class="home_mega_menu">
							...
							<div class="mobile-menu">
								<nav id="dropdown">
									<ul>
										...
										<li><a href="shop.php">Clothings</a>
											<ul>										
